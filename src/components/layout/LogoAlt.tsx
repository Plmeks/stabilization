...
/**
 * Альтернативный логотип Stabana (НЕ подключён по умолчанию): шестерёнка
 * (трапециевидные зубья) с круглой ступицей — сплошной 4-цветный «пирог»
 * (зелёный/синий/красный/оранжевый) без белых разделителей: цвета граничат
 * друг с другом напрямую. По центру пирога — белая галочка («готово/
 * качество»). Самодостаточный SVG.
 *
 * Это запасной вариант марки; основной логотип — кусочки пирога с белыми
 * разделителями (см. Logo.tsx). Эффекты (вращение шестерёнки + бегущее
 * свечение секторов) идентичны.
 *
 * Варианты:
