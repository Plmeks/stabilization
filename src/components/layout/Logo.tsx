...
export function Logo({
	...
	return (
		...
		>
			...
			{/* Белая обводка: внешний край ровно на краю пирога (r=10), а толщина
			    уходит ВНУТРЬ (r=8.9 + width=2.2 → внешний край = 10). Так шестерёнка
			    не срезается, а белая рамка широкая и чистая. */}
			<circle cx={24} cy={24} r={8.9} fill="none" stroke="var(--card)" strokeWidth={2.2} />
		</svg>
	);
}
