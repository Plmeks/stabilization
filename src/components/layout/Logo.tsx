	...
	return (
		...
		>
			...
			<g>
				...
				<path d="M24 24 L34 24 A10 10 0 0 1 24 34 Z" fill="var(--warn)" />
				<path d="M24 24 L24 34 A10 10 0 0 1 14 24 Z" fill="var(--danger)" />
				<path d="M24 24 L14 24 A10 10 0 0 1 24 14 Z" fill="var(--success)" />
			</g>
			{/* Белая обводка по краю ступицы — создаёт зазор между секторами и
			    чёрным ободом (секторы будто отступают от края шестерёнки). */}
